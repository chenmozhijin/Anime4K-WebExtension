...
#### Разрешения и использование в Firefox

Пользователям Firefox рекомендуется включить **«Доступ к вашим данным для всех веб-сайтов»** на странице расширения **«Разрешения и данные»**. После этого NijiLucid можно использовать на поддерживаемых видеосайтах без ручной активации каждого сайта.

Если вы не хотите включать доступ ко всем веб-сайтам, NijiLucid можно использовать по запросу:

1. Откройте веб-страницу с видео.
2. Нажмите значок расширения NijiLucid на панели инструментов Firefox, чтобы активировать текущую страницу.
3. Чтобы сохранить разрешение для текущего сайта, щёлкните правой кнопкой мыши значок расширения и выберите в меню постоянный доступ NijiLucid на этом сайте.
4. При переходе на другой сайт, для которого разрешение ещё не выдано, повторите эти действия.
