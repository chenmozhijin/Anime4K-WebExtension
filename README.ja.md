...
NijiLucid は Anime4K リアルタイム超解像アルゴリズムを利用して、アニメ動画の画質を大幅に向上させ、フレームごとに、より鮮明でシャープな視覚体験を提供します！
...
- 🧪 **高度なカスタムエフェクト:** カスタムモードでは ArtCNN、ACNet、CuNNy などのエフェクトを利用できます。これらは自動推奨には使われず、内蔵モードとしても表示されません。
...
- [![Chrome Web Store Version](https://img.shields.io/chrome-web-store/v/hpmbccepehpoanjpjkamfdpdkbmfmhek?style=flat-square&label=Chrome%E3%82%A6%E3%82%A7%E3%83%96%E3%82%B9%E3%83%88%E3%82%A2)](https://chromewebstore.google.com/detail/nijilucid/hpmbccepehpoanjpjkamfdpdkbmfmhek)
...
2. "Assets" セクションから最新の `nijilucid.zip` をダウンロード
3. ZIPファイルを解凍
...
*   **高度なエフェクト**: ArtCNN、ACNet、CuNNy をカスタムモードで手動追加できます。高負荷の実験的な構成向けで、現在のバージョンでは GPU ベンチマークによる自動推奨や内蔵モードとしては提供されません。
