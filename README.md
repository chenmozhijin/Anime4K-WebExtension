...
建议 Firefox 用户在扩展的“权限与数据”页面开启“访问您在所有网站的数据”。开启后，打开支持的视频网站即可直接使用，无需逐个网站手动激活。

如果不希望开启全站权限，也可以按需使用：

1. 打开要播放视频的网页。
2. 点击 Firefox 工具栏中的 NijiLucid 扩展图标，即可激活当前网页。
3. 如果希望持续允许 NijiLucid 在当前网站运行，可以右键点击扩展图标，在菜单中允许 NijiLucid 在该网站上持续访问。
4. 切换到其他未授权的网站时，重复上述操作即可。
