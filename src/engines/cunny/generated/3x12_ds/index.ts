...
export const CuNNy3x12DsConfig: CuNNyGeneratedModelConfig = {
  key: "CUNNY_3X12_DS",
  name: "CuNNy 3x12 DS",
  variant: "ds",
  stages: [
    {
      name: "CuNNy-3x12-DS-in",
    ...
    {
      name: "CuNNy-3x12-DS-out-shuffle",
...
export default CuNNy3x12DsConfig;
