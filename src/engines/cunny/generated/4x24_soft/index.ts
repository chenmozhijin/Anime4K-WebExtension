...
export const CuNNy4x24SoftConfig: CuNNyGeneratedModelConfig = {
  key: "CUNNY_4X24_SOFT",
  name: "CuNNy 4x24 SOFT",
  variant: "soft",
  stages: [
    {
      name: "CuNNy-4x24-SOFT-in",
    ...
    {
      name: "CuNNy-4x24-SOFT-out-shuffle",
...
export default CuNNy4x24SoftConfig;
