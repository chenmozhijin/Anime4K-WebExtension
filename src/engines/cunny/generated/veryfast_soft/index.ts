...
export const CuNNyVeryfastSoftConfig: CuNNyGeneratedModelConfig = {
  key: "CUNNY_VERYFAST_SOFT",
  name: "CuNNy veryfast SOFT",
  variant: "soft",
  stages: [
    {
      name: "CuNNy-veryfast-SOFT-in",
    ...
    {
      name: "CuNNy-veryfast-SOFT-conv1",
    ...
    {
      name: "CuNNy-veryfast-SOFT-conv2",
    ...
    {
      name: "CuNNy-veryfast-SOFT-out-shuffle",
...
export default CuNNyVeryfastSoftConfig;
