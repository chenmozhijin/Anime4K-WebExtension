...
fn computeMain(
  ...
  var r0: vec4f;
  r0 = vec4f(0.0);
  s0_0_0 = sample_conv2_vec4(pixel.xy, vec2i(-1, -1), vec2i(0, 0), vec2i(1, 1));
  s0_0_1 = sample_conv2_vec4(pixel.xy, vec2i(0, -1), vec2i(0, 0), vec2i(1, 1));
  s0_0_2 = sample_conv2_vec4(pixel.xy, vec2i(1, -1), vec2i(0, 0), vec2i(1, 1));
  s0_1_0 = sample_conv2_vec4(pixel.xy, vec2i(-1, 0), vec2i(0, 0), vec2i(1, 1));
  s0_1_1 = sample_conv2_vec4(pixel.xy, vec2i(0, 0), vec2i(0, 0), vec2i(1, 1));
  s0_1_2 = sample_conv2_vec4(pixel.xy, vec2i(1, 0), vec2i(0, 0), vec2i(1, 1));
  s0_2_0 = sample_conv2_vec4(pixel.xy, vec2i(-1, 1), vec2i(0, 0), vec2i(1, 1));
  s0_2_1 = sample_conv2_vec4(pixel.xy, vec2i(0, 1), vec2i(0, 0), vec2i(1, 1));
  s0_2_2 = sample_conv2_vec4(pixel.xy, vec2i(1, 1), vec2i(0, 0), vec2i(1, 1));
