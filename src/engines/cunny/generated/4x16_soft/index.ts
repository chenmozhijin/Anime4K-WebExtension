...
export const CuNNy4x16SoftConfig: CuNNyGeneratedModelConfig = {
  key: "CUNNY_4X16_SOFT",
  name: "CuNNy 4x16 SOFT",
  variant: "soft",
  stages: [
    {
      name: "CuNNy-4x16-SOFT-in",
    ...
    {
      name: "CuNNy-4x16-SOFT-out-shuffle",
...
export default CuNNy4x16SoftConfig;
