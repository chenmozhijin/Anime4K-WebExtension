...
export const CuNNy4x24DsConfig: CuNNyGeneratedModelConfig = {
  key: "CUNNY_4X24_DS",
  name: "CuNNy 4x24 DS",
  variant: "ds",
  stages: [
    {
      name: "CuNNy-4x24-DS-in",
    ...
    {
      name: "CuNNy-4x24-DS-out-shuffle",
...
export default CuNNy4x24DsConfig;
