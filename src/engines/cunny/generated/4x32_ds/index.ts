...
export const CuNNy4x32DsConfig: CuNNyGeneratedModelConfig = {
  key: "CUNNY_4X32_DS",
  name: "CuNNy 4x32 DS",
  variant: "ds",
  stages: [
    {
      name: "CuNNy-4x32-DS-in",
    ...
    {
      name: "CuNNy-4x32-DS-out-shuffle",
...
export default CuNNy4x32DsConfig;
