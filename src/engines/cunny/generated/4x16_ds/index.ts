...
export const CuNNy4x16DsConfig: CuNNyGeneratedModelConfig = {
  key: "CUNNY_4X16_DS",
  name: "CuNNy 4x16 DS",
  variant: "ds",
  stages: [
    {
      name: "CuNNy-4x16-DS-in",
    ...
    {
      name: "CuNNy-4x16-DS-out-shuffle",
...
export default CuNNy4x16DsConfig;
