...
export const CuNNy2x12DsConfig: CuNNyGeneratedModelConfig = {
  key: "CUNNY_2X12_DS",
  name: "CuNNy 2x12 DS",
  variant: "ds",
  stages: [
    {
      name: "CuNNy-2x12-DS-in",
    ...
    {
      name: "CuNNy-2x12-DS-out-shuffle",
...
export default CuNNy2x12DsConfig;
