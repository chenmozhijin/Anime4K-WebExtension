...
export const CuNNy4x12SoftConfig: CuNNyGeneratedModelConfig = {
  key: "CUNNY_4X12_SOFT",
  name: "CuNNy 4x12 SOFT",
  variant: "soft",
  stages: [
    {
      name: "CuNNy-4x12-SOFT-in",
    ...
    {
      name: "CuNNy-4x12-SOFT-out-shuffle",
...
export default CuNNy4x12SoftConfig;
